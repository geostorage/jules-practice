...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        # 字体设置 - 优先使用 MiSans，降级为 Microsoft YaHei UI
        available_fonts = tkinter.font.families()
        if "MiSans" in available_fonts:
            self.font_family = "MiSans"
        else:
        ...
        self.navigation_frame_label = customtkinter.CTkLabel(
            ...
            text="  井 然",
            font=customtkinter.CTkFont(family=self.font_family, size=28, weight="bold")
        )
        self.navigation_frame_label.grid(row=0, column=0, padx=20, pady=(20, 40))

        # 导航按钮公用字体
        nav_font = customtkinter.CTkFont(family=self.font_family, size=16, weight="normal")

        # 品牌蓝色 (用于选中状态)
        self.brand_blue = "#1f6aa5"
        self.brand_blue_hover = "#144870"

        # 待办事项按钮
        self.todo_button = customtkinter.CTkButton(
            self.navigation_frame, corner_radius=0, height=40, border_spacing=10, text="待办事项",
            font=nav_font,
            fg_color="transparent", text_color=("gray10", "gray90"), hover_color=self.brand_blue_hover,
            anchor="w", command=self.todo_button_event
        )
        self.todo_button.grid(row=1, column=0, sticky="ew")

        # 密码管理按钮
        self.password_button = customtkinter.CTkButton(
            self.navigation_frame, corner_radius=0, height=40, border_spacing=10, text="密码管理",
            font=nav_font,
            fg_color="transparent", text_color=("gray10", "gray90"), hover_color=self.brand_blue_hover,
        ...
        # 桌面整理按钮
        self.desktop_button = customtkinter.CTkButton(
            self.navigation_frame, corner_radius=0, height=40, border_spacing=10, text="桌面整理",
            font=nav_font,
            fg_color="transparent", text_color=("gray10", "gray90"), hover_color=self.brand_blue_hover,
        ...
        self.settings_button = customtkinter.CTkButton(
            self.navigation_frame, corner_radius=0, height=40, border_spacing=10, text="设置",
            font=nav_font,
            fg_color="transparent", text_color=("gray10", "gray90"), hover_color=self.brand_blue_hover,
        ...
        # 页面大标题公用字体
        title_font = customtkinter.CTkFont(family=self.font_family, size=48, weight="bold")
        ...
        self.todo_label = customtkinter.CTkLabel(self.todo_frame, text="待办事项", font=title_font)
        ...
        self.password_label = customtkinter.CTkLabel(self.password_frame, text="密码管理", font=title_font)
        ...
        self.desktop_label = customtkinter.CTkLabel(self.desktop_frame, text="桌面整理", font=title_font)
        ...
        self.settings_label = customtkinter.CTkLabel(self.settings_frame, text="设置", font=title_font)
    ...
    def select_frame_by_name(self, name):
        ...
        # 被选中的按钮背景色变成品牌蓝色，未选中的恢复透明背景
        self.todo_button.configure(fg_color=self.brand_blue if name == "待办事项" else "transparent")
        self.password_button.configure(fg_color=self.brand_blue if name == "密码管理" else "transparent")
        self.desktop_button.configure(fg_color=self.brand_blue if name == "桌面整理" else "transparent")
        self.settings_button.configure(fg_color=self.brand_blue if name == "设置" else "transparent")
